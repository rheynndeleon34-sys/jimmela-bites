const stockItems = [
  { product: "Pork Siomai", sku: "SIO-PRK", stock: 2400, unit: "packs", status: "In Stock" },
  { product: "Beef Siomai", sku: "SIO-BEF", stock: 1850, unit: "packs", status: "In Stock" },
  { product: "Japanese Siomai", sku: "SIO-JPN", stock: 320, unit: "packs", status: "Low Stock" },
  { product: "Shark's Fin Siomai", sku: "SIO-SHK", stock: 980, unit: "packs", status: "In Stock" },
  { product: "Longganisa Original", sku: "LNG-ORI", stock: 1600, unit: "packs", status: "In Stock" },
  { product: "Longganisa Garlic", sku: "LNG-GRL", stock: 85, unit: "packs", status: "Low Stock" },
];
  ...
  <div>
    ...
    <div className="bg-card rounded-xl border border-border shadow-sm overflow-x-auto">
      <table className="w-full text-sm">
        ...
        <tbody>
          {stockItems.map((s) => (
            <tr key={s.sku} className="border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
              ...
              <td className="px-5 py-3.5">
                <span className={`inline-block px-2.5 py-1 rounded-full text-xs font-semibold ${statusStyles[s.status]}`}>
                  {s.status}
                </span>
              </td>
            </tr>
